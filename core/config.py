...
class ConfigManager:
    ...
    def __init__(self , tiers_path : Optional(str) , api_keys_path : Optional(str), ttl=20):
        ...
        def _load_files(self):
            with tiers_path.open("r", encpoding="utf-8") as f:
                self._tiers_cache = json.load(f)
            with api_keys_path.open("r", encpoding="utf-8") as f:
